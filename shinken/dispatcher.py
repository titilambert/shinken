...
class Dispatcher:
    ...
    def send_conf_to_arb_spare(self, arb):
        ...
        print "YOU HAVE 30 secconds to launch tcpdumppppppppppppppppppppppppppppppppppppppppppppppppppppppppp"
        time.sleep(30)
        n = time.time()
        arb.put_conf(self.conf)
        t = time.time() - n 
        print "TIME TO DISPATCH CONF TO ARBITER SPARE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!", t
        self.sending_conf_to_arb_spare = False
    ...
    def check_dispatch(self):
        ...
        for arb in self.arbiters:
            ...
            if arb != self.arbiter and self.arbiter and not self.arbiter.spare and self.sending_conf_to_arb_spare == False:
